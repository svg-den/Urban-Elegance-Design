...
const Portfolio = () => {
  ...
  const projects = [
    ...
    { id: 2, title: "Managers Room", type: "video", content: video2 },
    {
      ...
      title: "Project 3",
      type: "images",
      content: [image1, image2, image3, image4, image5, image6],
    },
  ];
  ...
  return (
    <div
      id="portfolio"
      className="mt-9 bg-gray-100 text-gray-800 py-8 px-4 min-h-screen max-w-screen-lg mx-auto"
    >
      <h3 className="text-4xl text-center font-bold mb-4 underline">
        Completed Projects
      </h3>
